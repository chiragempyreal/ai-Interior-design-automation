      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
          ...
          >
            ...
            {/* Footer */}
            <div className="px-8 py-6 bg-charcoal/[0.02] border-t border-charcoal/5 flex justify-end gap-3 relative z-10">
              {secondaryActionLabel && (
                <button
                  onClick={handleSecondaryAction}
                  className="px-6 py-3 rounded-full font-geist text-[11px] font-bold tracking-[0.2em] uppercase transition-all bg-white border border-charcoal/10 text-charcoal/60 hover:text-charcoal hover:bg-charcoal/5 hover:border-charcoal/20"
                >
                  {secondaryActionLabel}
                </button>
              )}
              <button
                ...
                className={`px-8 py-3 rounded-full font-geist text-[11px] font-bold tracking-[0.2em] uppercase transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 active:scale-95 ${
                  ...
                  type === 'warning' ? 'bg-[#E5B454] hover:bg-[#D4A343] text-white shadow-[#E5B454]/20' :
